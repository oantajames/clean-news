...
/**
 * Abstract class for a Use Case (Interactor in terms of Clean Architecture). This interface
 ...
 * DisposableObserver} that will execute its job in a background thread and will post the result in
 * the UI thread.
 */
